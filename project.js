...
function handle_cartItem() {
    ...
    if (itemsAdded.find((el)=>el.title == newAdd.title )){
        alert('This Item Is Already Exist');
        return;
    }
    else {
        itemsAdded.push(newAdd);
    }
    // Add product to cart
...
function updateTotal(){
    ...
    const totalElement = cart.querySelector(".total-title"); 
    let total = 0 ;
    ...
    total = total.toFixed(2) // keep 2 digits after decimal point
